...
//  (G) GAME_VERSION !== "1.0.0.37" (phase-local pin, mirrored at CS038 P7's version bump).
...
// ================= (G) version bump =====================
(function () {
  console.log("(G) GAME_VERSION !== \"1.0.0.37\"");
  const A = buildInstance();
  assert(A.GAME_VERSION !== "1.0.0.37", "G: GAME_VERSION has moved on from \"1.0.0.37\"");
})();
