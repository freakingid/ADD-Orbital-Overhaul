...
// lab-verified text/phon, no derivation), GAME_VERSION === "1.0.0.22", and that superMegaDelivery()
...
// the REAL asteroids-deluxe.html source through the same build()-a-headless-instance harness as
...
(function sectionB() {
  ...
  eq(scriptSrc.match(/const GAME_VERSION = "([^"]+)"/)[1], "1.0.0.22", "GAME_VERSION bumped to 1.0.0.22");
