...
// lab-verified text/phon, no derivation), GAME_VERSION === "1.0.0.24", and that superMegaDelivery()
...
(function sectionB() {
  ...
  eq(scriptSrc.match(/const GAME_VERSION = "([^"]+)"/)[1], "1.0.0.24", "GAME_VERSION bumped to 1.0.0.24");
