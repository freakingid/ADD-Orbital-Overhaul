...
(function sectionB() {
  ...
  eq(X.DEBUG_ENTRIES.length, 106, "B: ⛔ DEBUG_ENTRIES.length is unchanged from this phase's own parent (bar CS030 P3's two, CS034 P8's net four, CS035 P2's one, CS035 P3's four, CS035 P4's five, CS035 P6's five, CS036 P2's one retirement and CS036 P5's one addition later) — G1=C carries no new registry row");
