...
(function sectionH() {
  ...
  // ordered header list.
  eq(values.length, 81, "H: 81 value entries remain — the 21-tier-knob prune, P5's lever-knob rebuild, P6's POWERUPS section, P6c's three rows per lever, P6d's startLevel, P6e's debugOverride, P6f's three Hunter-cap knobs, CS025 P1's magnetResumeDelay, CS025 P2's two magnet-push knobs, CS026 P2's three junkSplit lever knobs, CS026 P3's earlyWorldLevels");
  eq(X.DEBUG_ENTRIES.length, 81, "H: DEBUG_ENTRIES agrees — headers are not values [CS026 P4 -> 81]");
