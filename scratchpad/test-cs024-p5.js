...
(function sectionG() {
  ...
  eq(values.length, 78, "G: DEBUG_VARS has exactly 78 value entries (CS024 P6f: +3 Hunter-cap knobs; CS025 P1: +magnetResumeDelay; CS025 P2: +magnetPushKick/magnetPushSpread; CS026 P2: +3 junkSplit lever knobs)");
  eq(A.DEBUG_ENTRIES.length, 78, "G: DEBUG_ENTRIES agrees — headers are not values");
