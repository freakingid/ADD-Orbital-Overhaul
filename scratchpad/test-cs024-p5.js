...
(function sectionG() {
  ...
  eq(values.length, 79, "G: DEBUG_VARS has exactly 79 value entries (CS024 P6f: +3 Hunter-cap knobs; CS025 P1: +magnetResumeDelay; CS025 P2: +magnetPushKick/magnetPushSpread; CS026 P2: +3 junkSplit lever knobs; CS026 P3: +earlyWorldLevels)");
  eq(A.DEBUG_ENTRIES.length, 79, "G: DEBUG_ENTRIES agrees — headers are not values");
