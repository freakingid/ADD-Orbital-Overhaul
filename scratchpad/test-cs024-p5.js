...
(function sectionG() {
  ...
  eq(values.length, 68, "G: DEBUG_VARS has exactly 68 value entries (CS024 P6d repoint: +1 startLevel)");
  eq(A.DEBUG_ENTRIES.length, 68, "G: DEBUG_ENTRIES agrees — headers are not values");
