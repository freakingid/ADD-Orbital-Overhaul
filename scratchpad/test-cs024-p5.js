...
(function sectionG() {
  ...
  eq(values.length, 69, "G: DEBUG_VARS has exactly 69 value entries (CS024 P6e repoint: +1 debugOverride)");
  eq(A.DEBUG_ENTRIES.length, 69, "G: DEBUG_ENTRIES agrees — headers are not values");
