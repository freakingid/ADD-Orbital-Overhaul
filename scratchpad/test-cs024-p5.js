...
(function sectionG() {
  ...
  eq(values.length, 72, "G: DEBUG_VARS has exactly 72 value entries (CS024 P6f repoint: +3 Hunter-cap knobs)");
  eq(A.DEBUG_ENTRIES.length, 72, "G: DEBUG_ENTRIES agrees — headers are not values");
