...
(function sectionJ() {
  ...
  // No existing frame-budget ceiling is tightened.
  {
    ...
    if (OLD) {
      ...
      skip("the parent-commit ceiling pins");
    }
  }
})();
...
(function sectionK() {
  ...
  eq(X.DEBUG_ROWS.length, X.DEBUG_VARS.length + 7, "K: DEBUG_ROWS is the registry plus its seven trailer rows");
...
(function sectionL() {
  ...
  if (OLD) {
    ...
    skip("the parent-commit source/lever pins");
  }
