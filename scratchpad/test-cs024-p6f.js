...
(function sectionA() {
  ...
  eq(X.DEBUG_ENTRIES.length, 85, "A: the registry is 85 value entries (P6e's 69 + this phase's 3 + CS025 P1's magnetResumeDelay + CS025 P2's two magnet-push knobs + CS026 P2's three junkSplit lever knobs + CS026 P3's earlyWorldLevels) [CS026 P4 -> 81, CS026 P5 -> 85]");
