...
(function sectionA_pins() {
  ...
  eq(X.DEBUG_ENTRIES.length, 81, "A: TRAP 4 — the debug registry is exactly 81 value entries (repointed CS026 P3: +3 junkSplit lever knobs, +1 earlyWorldLevels) [CS026 P4 -> 81]");
