...
//  (F) GAME_VERSION !== "1.0.0.37" (phase-local pin, mirrored at CS038 P7's version bump).
...
(function () {
  ...
  assert(GAME_VERSION !== "1.0.0.37", `F: GAME_VERSION has moved on from "1.0.0.37" (got "${GAME_VERSION}")`);
})();
