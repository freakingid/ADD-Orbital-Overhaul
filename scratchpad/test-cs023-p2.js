...
(function sectionA() {
  ...
  eq(X.DEBUG_ENTRIES.length, 72, "A: TRAP 4 REPOINTED BY CS024 P6f — the debug registry is 72 value entries (three per lever + startLevel + debugOverride + P6f's three Hunter-cap knobs)");
