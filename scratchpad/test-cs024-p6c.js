...
(function sectionG() {
  ...
  // CS035 P6 repoint: +5 more (chainGuardDropBase/Pity/Max, CHAIN GUARD — the guard drop-weight pity
  // curve; sweepPowerupCap, dockPowerupSpeed, POWERUPS — the Super Mega Delivery's volume). Not levers,
  ...
  // CS037 P7 repoint: +2 more (dockBaseScore, dockBonusStep, DELIVERY — the delivery score curve's
  // two constants, promoted to knobs). Not levers, spec §7.4: flat score numbers with no chain, no
  // floor/ceil/steps triple. Same reasoning a fourteenth time.
  // CS037 P7.1 repoint: +2 more (towReleaseLockout, towReleaseSpeed, SHIP — the tow release
  // separation's two knobs). Not levers, spec §7.1.4: flat feel numbers with no chain, no
  // floor/ceil/steps triple. Same reasoning a fifteenth time.
  ...
  // CS040 P3 repoint: +1 more (healthBankMax, POWERUPS — the health bank's cap). Not a lever, spec
  // §1.4: a pacing cap with no chain and no floor/ceil/steps triple. Same reasoning a seventeenth time.
  // CS040 P4 repoint: +1 more (hubDryWeightMult, POWERUPS — the hub's dry-weapon relief multiplier).
  // Not a lever, spec §2.2: a pacing multiplier with no chain and no floor/ceil/steps triple. Same
  // reasoning an eighteenth time.
  ...
  // CS042 P10 repoint: +2 more (menuRepeatDelay/menuRepeatRate, GLOBAL — the menu's own held-direction
  // repeat timer, spec §5.2). Not a lever: menu pacing is not a difficulty axis — no chain, no
  // floor/ceil/steps triple. Same reasoning a twenty-second time.
  eq(nonLever.length, 63, "G: 63 non-lever knobs survive P6/P6d/P6e/P6f + CS025 P1/P2 + CS026 P3/P4/P5 + CS030 P3 + CS034 P8 + CS035 P2/P3/P4/P6 + CS036 P2/P5 + CS037 P2/P4/P7/P7.1 + CS038 P3/P5 + CS040 P2/P3/P4 + CS042 P6/P7/P9/P10's registry");
