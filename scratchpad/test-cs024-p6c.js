...
(function sectionG() {
  ...
  eq(nonLever.length, 55, "G: 55 non-lever knobs survive P6/P6d/P6e/P6f + CS025 P1/P2 + CS026 P3/P4/P5 + CS030 P3 + CS034 P8 + CS035 P2/P3/P4/P6 + CS036 P2/P5 + CS037 P2/P4/P7/P7.1 + CS038 P3/P5 + CS040 P2/P3's registry");
