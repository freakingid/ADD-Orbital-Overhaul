...
(function sectionF() {
  ...
  eq(X.DEBUG_ENTRIES.length, 67, "F: TRAP — the debug registry is exactly 67 value entries after CS024 P6c");
  eq(X.DEBUG_VARS.filter(v => !v.header).length, 67, "F: ...and DEBUG_VARS agrees");
