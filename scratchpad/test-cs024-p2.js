...
(function sectionF() {
  ...
  eq(X.DEBUG_ENTRIES.length, 69, "F: TRAP — the debug registry is exactly 69 value entries after CS024 P6e");
  eq(X.DEBUG_VARS.filter(v => !v.header).length, 69, "F: ...and DEBUG_VARS agrees");
