...
(function sectionF() {
  ...
  eq(X.DEBUG_ENTRIES.length, 75, "F: TRAP — the debug registry is exactly 75 value entries after CS025 P2");
  eq(X.DEBUG_VARS.filter(v => !v.header).length, 75, "F: ...and DEBUG_VARS agrees");
