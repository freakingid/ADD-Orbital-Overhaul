...
(function sectionF() {
  ...
  eq(X.DEBUG_ENTRIES.length, 78, "F: TRAP — the debug registry is exactly 78 value entries after CS026 P2");
  eq(X.DEBUG_VARS.filter(v => !v.header).length, 78, "F: ...and DEBUG_VARS agrees");
