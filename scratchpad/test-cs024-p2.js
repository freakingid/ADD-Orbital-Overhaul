...
(function sectionF() {
  ...
  eq(X.DEBUG_ENTRIES.length, 68, "F: TRAP — the debug registry is exactly 68 value entries after CS024 P6d");
  eq(X.DEBUG_VARS.filter(v => !v.header).length, 68, "F: ...and DEBUG_VARS agrees");
