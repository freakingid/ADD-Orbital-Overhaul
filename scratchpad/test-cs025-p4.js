...
(function () {
  ...
  assert(A.DEBUG_ENTRIES.length === 78, `TRAP 4 (repointed CS026 P2, which added the three junkSplit lever knobs): the registry is 78 rows; got ${A.DEBUG_ENTRIES.length}`);
