...
(function () {
  ...
  assert(A.DEBUG_ENTRIES.length === 85, `TRAP 4 (repointed CS026 P5, which added the four level banner knobs on top of P3's earlyWorldLevels and P2's three junkSplit lever knobs): the registry is 85 rows; got ${A.DEBUG_ENTRIES.length}`);
