...
(function sectionF() {
  ...
  // REPOINTED BY CS037 P4: +5 -> +6 — the telemetry export row joined it too.
  // REPOINTED BY CS040 P6: +6 -> +5 — that row moved off this panel onto Options' Telemetry sub-screen.
