...
//  (H) GAME_VERSION !== "1.0.0.37" (phase-local pin, mirrored at CS038 P7's version bump).
...
// ================= (H) GAME_VERSION pin =====================
(function sectionH() {
  console.log("(H) GAME_VERSION !== \"1.0.0.37\"");
  const { GAME_VERSION } = build();
  assert(GAME_VERSION !== "1.0.0.37", `H: GAME_VERSION has moved on from "1.0.0.37" (got "${GAME_VERSION}")`);
})();
