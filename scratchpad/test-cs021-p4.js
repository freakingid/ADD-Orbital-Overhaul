...
const htmlPath = process.env.CS021_HTML || path.join(repoRoot, "orbital-overhaul.html");
...
(function sectionA_pins() {
  ...
  eq(GAME_VERSION, "1.0.0.38", "A: GAME_VERSION is HEAD's — a live pin, re-pointed by each changeset's closing phase");
})();
