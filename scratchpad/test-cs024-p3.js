...
(function sectionA_removals() {
  ...
  eq(X.DEBUG_ENTRIES.length, 75, "A: the registry holds 75 value entries after CS025 P2 (P6c's three rows per lever + startLevel + debugOverride + the three Hunter-cap knobs + magnetResumeDelay + the two magnet-push knobs)");
