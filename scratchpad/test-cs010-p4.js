...
(function () {
  ...
  // CS031 P5 inserted "Profile" as the second row; CS032 P4 inserted "Load Saved Game" ahead of it,
  // beside "Start Game"; CS033 P2 inserted "Leaderboard" beside "High Scores" — pinned to its current
  // post-P2 shape, the same "re-runs against the current build" precedent MENU_ROOT_PLAY's own comment
  // above already follows.
  assert(JSON.stringify(A.MENU_TITLE) === JSON.stringify(["Start Game", "Load Saved Game", "Profile", "Achievements", "High Scores", "Leaderboard", "Options"]),
