...
(function () {
  ...
  // beside "Start Game" — pinned to its current post-P4 shape, the same "re-runs against the current
  // build" precedent MENU_ROOT_PLAY's own comment above already follows.
  assert(JSON.stringify(A.MENU_TITLE) === JSON.stringify(["Start Game", "Load Saved Game", "Profile", "Achievements", "High Scores", "Options"]),
