...
//
// Sections:
//  (A) node --check on the extracted <script>; GAME_VERSION === "1.0.0.40" (live pin, tracks HEAD).
...
// ================= (A2) GAME_VERSION pin =====================
(function sectionA() {
  assert(GAME_VERSION === "1.0.0.40", `A: GAME_VERSION is exactly "1.0.0.40" (got "${GAME_VERSION}")`);
